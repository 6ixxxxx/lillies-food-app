...
import w40 from "../assets/40w.png";
...
function Products(props) {
     ...
     return (
          <main className="products">
               ...
               <header>
                    <p className='greetings'>Good Morning, Lucy!<br/> <span>What delicious meal are you craving for today?</span></p>
                    <img className='user' src={w40} alt="" ></img>
               </header>
